...
const answers = {
    ...
    exec: {
        ...
        [`/home/bin/maven/bin/mvn -f pom.xml help:effective-pom ${options}`]: {
            code: 0,
        ...
        [`/home/bin/maven/bin/mvn -f pom.xml -s ${path.join(TestUtils_1.getTempDir(), "settings.xml")} ${optionsWithoutSettings} package`]: {
            code: 0,
