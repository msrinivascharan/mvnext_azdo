...
function jacocoGradleMultiModuleEnable(excludeFilter, includeFilter, classFileDirectory, reportDir) {
    return `
allprojects {
    repositories {
        mavenCentral()
...
function jacocoGradleSingleModuleEnable(excludeFilter, includeFilter, classFileDirectory, reportDir) {
    return `
allprojects {
    repositories {
        mavenCentral()
